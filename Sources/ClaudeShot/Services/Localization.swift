...
final class Localizer {
    ...
    static let en: [String: String] = [
        ...
        "settings.hotkeyCaption": "Press this shortcut anywhere to capture the frontmost window and paste it into Claude.",
    ...
    static let ja: [String: String] = [
        ...
        "settings.hotkeyCaption": "このショートカットをどこでも押すと、最前面のウィンドウをキャプチャして Claude に貼り付けます。",
